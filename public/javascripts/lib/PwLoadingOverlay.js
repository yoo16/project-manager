...
var PwLoadingOverlay = function() {
    ...
    this.backgroundSize = function(element) {
        ...
        var width_rate = 0;
        var height_rate = 0;
        if (img.width > element.clientWidth) width_rate = element.clientWidth / img.width;
        if (img.height > element.clientHeight) height_rate = element.clientHeight / img.height;
        var rate = 0;
...
var pw_loading_overlay = new PwLoadingOverlay();
