...
var PwUI = function() {
     ...
     * loading overlay
     */
    this.showLoading = function(selector, options) {
        pw_loading_overlay.show(selector, options);
    }
    this.hideLoading = function(selector, options) {
        pw_loading_overlay.hide(selector, options);
    }
    /**
     * Modal
     */
    ...
    this.base64ToFile = function(data) {
