...
var PwUI = function() {
    ...
    this.loading_overlay_name = 'pw_loading_overlay';
    this.loading_overlay_element;
    this.loading_overlay_body = 'pw_body_loading_overlay';
    ...
    this.showLoading = function(selector) {
        //TODO style setting
        var style = "background-image: url(" + pw_loading_image + ");";
    ...
    this.hideLoading = function(selector) {
        ...
        pw_modal.hide(_this.loading_overlay_body);
    }
    ...
    this.reloadDeleteConfirm = function() {
        ...
        let elements = document.getElementsByClassName(_this.confirm_delete_name);
        [].forEach.call(elements, function(element) {
            element.addEventListener('click', _this.deleteConfirmHandler, false);
        });
    }
    ...
    this.reloadPopupEvent = function() {
        //IE dosen't work elements.forEach()
        let elements = document.getElementsByClassName(_this.popup_name);
        [].forEach.call(elements, function(element) {
            element.addEventListener('click', _this.popupEventHandler, false);
        });
    }
    ...
    this.confirmDialogHandler = function(event) {
        ...
        _this.reloadConfirmDialogEvent();
    ...
    this.reloadConfirmDialogEvent = function() {
        //IE dosen't work elements.forEach()
        let elements = document.getElementsByClassName(_this.confirm_dialog_name);
        [].forEach.call(elements, function(element) {
            element.addEventListener('click', _this.confirmDialogHandler, false);
        });
    }
    ...
    this.deleteCheckbox = function() {
        //IE dosen't work elements.forEach()
        let elements = document.getElementsByClassName(_this.delete_checkbox_name);
        [].forEach.call(elements, function(element) {
